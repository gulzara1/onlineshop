    ...
    <div className="flex-1 py-8 px-10">
      ...
      <div className="flex space-x-2">
      {
        categories && categories.map(category => (
          <button className="text-white bg-violet-700 rounded px-4 py-2 hover:bg-gray-700" onClick={() => navigate(category == "барлығы" ? "/products" : "?category="+category)}>{category}</button>
        ))
      }
      </div>
